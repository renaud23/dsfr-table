        ...
        <div class="fr-container">
            ...
            <div class="fr-grid-row fr-grid-row--gutters fr-grid-row--center fr-mb-6v">
                <div class="fr-col-md-8 fr-col-xl-6 fr-col-12">
                    <fieldset class="fr-fieldset" id="nationality-7427" aria-labelledby="nationality-7427-legend nationality-7427-messages">
                        <legend class="fr-sr-only" id="nationality-7427-legend">
                            Nationalité
                        </legend>
                        <div class="fr-fieldset__element">
                            <div class="fr-select-group">
                                <label class="fr-label" for="nationality-select-7426">
                                    Nationalité
                                </label>
                                <select class="fr-select" aria-describedby="nationality-select-7426-messages" id="nationality-select-7426" name="country">
                                ...
                                <div class="fr-messages-group" id="nationality-select-7426-messages" aria-live="polite">
                                </div>
                            </div>
                        </div>
                        <div class="fr-messages-group" id="nationality-7427-messages" aria-live="polite">
                        </div>
                    </fieldset>
                </div>
            </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7430">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-7430">
                                <pre class=" language-html"><code>&lt;fieldset class="fr-fieldset" id="nationality-7429" aria-labelledby="nationality-7429-legend nationality-7429-messages"&gt;
    &lt;legend class="fr-sr-only" id="nationality-7429-legend"&gt;
        Nationalité
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-select-group"&gt;
            &lt;label class="fr-label" for="nationality-select-7428"&gt;
                Nationalité
            &lt;/label&gt;
            &lt;select class="fr-select" aria-describedby="nationality-select-7428-messages" id="nationality-select-7428" name="country"&gt;
                &lt;option value="" selected disabled&gt;Sélectionner une option&lt;/option&gt;
                &lt;option value="FR"&gt;Française&lt;/option&gt;
                &lt;option value="DE"&gt;Allemande&lt;/option&gt;
                &lt;option value="IT"&gt;Italienne&lt;/option&gt;
                &lt;option value="ES"&gt;Espagnole&lt;/option&gt;
            &lt;/select&gt;
            &lt;div class="fr-messages-group" id="nationality-select-7428-messages" aria-live="polite"&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    &lt;div class="fr-messages-group" id="nationality-7429-messages" aria-live="polite"&gt;
    &lt;/div&gt;
&lt;/fieldset&gt;
</code></pre>
                            </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7431" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
