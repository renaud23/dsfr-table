...
<body id="top" class="fr-mb-12w">
        ...
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <div class="fr-input-group" id="input-group-7705">
                    <label class="fr-label" for="tel-7704">
                        Numéro de téléphone
                        <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                    </label>
                    <input class="fr-input" autocomplete="tel" aria-describedby="tel-7704-messages" id="tel-7704" type="tel">
                    <div class="fr-messages-group" id="tel-7704-messages" aria-live="polite">
                    </div>
                </div>
            </div>
            <div class="fr-mb-12v">
    ...
    &lt;label class="fr-label" for="tel-7706"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-7706-messages" id="tel-7706" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-7706-messages" aria-live="polite"&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                    </div>
            ...
            <div class="fr-mb-6v">
                <div class="fr-input-group fr-input-group--error" id="input-group-7710">
                    <label class="fr-label" for="tel-7709">
                        Numéro de téléphone
                        <span class="fr-hint-text">Format attendu : (+33) 1 22 33 44 55</span>
                    </label>
                    <input class="fr-input" autocomplete="tel" aria-describedby="tel-7709-messages" id="tel-7709" type="tel">
                    <div class="fr-messages-group" id="tel-7709-messages" aria-live="polite">
                        <p class="fr-message fr-message--error" id="tel-7709-message-error">Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 1 22 33 44 55</p>
                    </div>
                </div>
            </div>
            <div class="fr-mb-12v">
                <section class="fr-accordion">
                    ...
                    <div class="fr-collapse" id="snippet-7713">
                        <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error" id="input-group-7712"&gt;
    &lt;label class="fr-label" for="tel-7711"&gt;
        Numéro de téléphone
        &lt;span class="fr-hint-text"&gt;Format attendu : (+33) 1 22 33 44 55&lt;/span&gt;
    &lt;/label&gt;
    &lt;input class="fr-input" autocomplete="tel" aria-describedby="tel-7711-messages" id="tel-7711" type="tel"&gt;
    &lt;div class="fr-messages-group" id="tel-7711-messages" aria-live="polite"&gt;
        &lt;p class="fr-message fr-message--error" id="tel-7711-message-error"&gt;Le format de numéro de téléphone saisie n’est pas valide. Le format attendu est : (+33) 1 22 33 44 55&lt;/p&gt;
    &lt;/div&gt;
&lt;/div&gt;
</code></pre>
                    </div>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7714" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
