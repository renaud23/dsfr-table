...
&lt;/svg&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-11631">Extrait de code</button>
                            </h3>
                            <div class="fr-collapse" id="snippet-11631">
                                <pre class=" language-html"><code>&lt;svg aria-hidden="true" class="fr-artwork" viewBox="0 0 80 80" width="80px" height="80px"&gt;
    &lt;use class="fr-artwork-decorative" href="../../../../dist/artwork/pictograms/health/health.svg#artwork-decorative"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-minor" href="../../../../dist/artwork/pictograms/health/health.svg#artwork-minor"&gt;&lt;/use&gt;
    &lt;use class="fr-artwork-major" href="../../../../dist/artwork/pictograms/health/health.svg#artwork-major"&gt;&lt;/use&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-11636" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
